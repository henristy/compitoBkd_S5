        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            @if (isset($header))
                <header class=" dark:bg-gray-800 shadow">
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex align-items-center">
                        <a class="text-white hover:text-blue-200 fs-5 me-4" href="{{ route('back') }}"><i class="bi bi-arrow-left"></i></a>
                        {{ $header }}
                    </div>
                </header>
            @endif
        ...
        <footer class="bg-gray-800 text-white">
            <div class="container mx-auto px-6 py-12">
                ...
                <div class="flex flex-col items-center justify-between md:flex-row">
                    <p class="mt-6 text-sm text-center text-white md:mt-0">
                        Project Manager App
                    </p>
            ...
            © 2024 Copyright: Project-Manager
            </div>
        </footer>
